...
from OPEN_CEP.base.PatternStructure import PatternStructure, CompositeStructure, UnaryStructure, PrimitiveEventStructure, \
    NegationOperator
from OPEN_CEP.misc.ConsumptionPolicy import ConsumptionPolicy
from OPEN_CEP.plan.TreePlan import TreePlan, TreePlanNode, TreePlanLeafNode, TreePlanNestedNode, TreePlanUnaryNode, \
    OperatorTypes, TreePlanInternalNode, TreePlanBinaryNode
from OPEN_CEP.tree.nodes.AndNode import AndNode
from OPEN_CEP.tree.nodes.KleeneClosureNode import KleeneClosureNode
from OPEN_CEP.tree.nodes.LeafNode import LeafNode
from OPEN_CEP.tree.nodes.NegationNode import NegativeSeqNode, NegativeAndNode, NegationNode
from OPEN_CEP.tree.nodes.Node import Node, PatternParameters
from OPEN_CEP.tree.PatternMatchStorage import TreeStorageParameters
from OPEN_CEP.tree.nodes.SeqNode import SeqNode


class Tree:
    """
    Represents an evaluation tree. Implements the functionality of constructing an actual tree from OPEN_CEP.tree plan
    ...
    def __handle_primitive_event(self, tree_plan_leaf: TreePlanLeafNode, primitive_event_structure: PatternStructure,
        ...
        """
        # this is a temporary hack used until the procedure is modified to extract event details from OPEN_CEP.tree plan leaves
