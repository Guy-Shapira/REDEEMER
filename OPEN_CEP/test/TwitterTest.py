...
from CEP import CEP
from OPEN_CEP.stream.FileStream import FileOutputStream
from OPEN_CEP.plugin.twitter.TwitterDataFormatter import (
    DummyTwitterEventTypeClassifier,
    TweetDataFormatter,
)
from OPEN_CEP.plugin.twitter.TwitterInputStream import TwitterInputStream
from datetime import timedelta
from OPEN_CEP.base.Formula import EqFormula, IdentifierTerm, AtomicTerm, AndFormula, NotEqFormula
from OPEN_CEP.base.PatternStructure import SeqOperator, PrimitiveEventStructure
